...
If a given dependency has no license specified, it's marked with `UNKNOWN` and thus the default blacklist contains `UNKNOWN` license to notify about potentialy unwanted license.
